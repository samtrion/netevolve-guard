...
{
  private static DateOnly BaseValue { get; } = DateOnly.FromDateTime(DateTime.Now);
  ...
  public static TheoryData GetInBetweenData => new TheoryData<bool, DateOnly, DateOnly, DateOnly>
    {
  ...
  public static TheoryData GetNotBetweenData => new TheoryData<bool, DateOnly, DateOnly, DateOnly>
    {
  ...
  public static TheoryData GetGreaterThanData => new TheoryData<bool, DateOnly, DateOnly>
    {
  ...
  public static TheoryData GetGreaterThanOrEqualData => new TheoryData<bool, DateOnly, DateOnly>
    {
      { true, BaseValue, MaxValue },
  ...
  public static TheoryData GetLessThanData => new TheoryData<bool, DateOnly, DateOnly>
    {
  ...
  public static TheoryData GetLessThanOrEqualData => new TheoryData<bool, DateOnly, DateOnly>
    {
      { true, BaseValue, MinValue },
      { false, BaseValue, BaseValue },
      { false, BaseValue, MaxValue }
