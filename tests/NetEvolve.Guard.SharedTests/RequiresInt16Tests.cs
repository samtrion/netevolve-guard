...
public sealed class RequiresInt16Tests
{
  ...
  public static TheoryData GetInBetweenData => new TheoryData<bool, short, short, short>
    {
  ...
  public static TheoryData GetNotBetweenData => new TheoryData<bool, short, short, short>
    {
  ...
  public static TheoryData GetGreaterThanData => new TheoryData<bool, short, short>
    {
  ...
  public static TheoryData GetGreaterThanOrEqualData => new TheoryData<bool, short, short>
    {
      { true, BaseValue, MaxValue },
  ...
  public static TheoryData GetLessThanData => new TheoryData<bool, short, short>
    {
  ...
  public static TheoryData GetLessThanOrEqualData => new TheoryData<bool, short, short>
    {
      { true, BaseValue, MinValue },
      { false, BaseValue, BaseValue },
      { false, BaseValue, MaxValue }
  ...
  public static TheoryData GetNotPow2Data => new TheoryData<bool, short>
    {
      { true, 63 },
      { false, 64 }
    };
