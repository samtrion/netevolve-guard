...
public sealed class RequiresTimeOnlyTests
{
  private static TimeOnly BaseValue { get; } = TimeOnly.FromDateTime(DateTime.Now);
  ...
  public static TheoryData GetInBetweenData => new TheoryData<bool, TimeOnly, TimeOnly, TimeOnly>
    {
  ...
  public static TheoryData GetNotBetweenData => new TheoryData<bool, TimeOnly, TimeOnly, TimeOnly>
    {
  ...
  public static TheoryData GetGreaterThanData => new TheoryData<bool, TimeOnly, TimeOnly>
    {
  ...
  public static TheoryData GetGreaterThanOrEqualData => new TheoryData<bool, TimeOnly, TimeOnly>
    {
      { true, BaseValue, MaxValue },
  ...
  public static TheoryData GetLessThanData => new TheoryData<bool, TimeOnly, TimeOnly>
    {
  ...
  public static TheoryData GetLessThanOrEqualData => new TheoryData<bool, TimeOnly, TimeOnly>
    {
      { true, BaseValue, MinValue },
      { false, BaseValue, BaseValue },
      { false, BaseValue, MaxValue }
