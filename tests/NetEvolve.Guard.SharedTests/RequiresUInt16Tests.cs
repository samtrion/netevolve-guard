...
public sealed class RequiresUInt16Tests
{
  ...
  public static TheoryData GetInBetweenData => new TheoryData<bool, ushort, ushort, ushort>
    {
  ...
  public static TheoryData GetNotBetweenData => new TheoryData<bool, ushort, ushort, ushort>
    {
  ...
  public static TheoryData GetGreaterThanData => new TheoryData<bool, ushort, ushort>
    {
  ...
  public static TheoryData GetGreaterThanOrEqualData => new TheoryData<bool, ushort, ushort>
    {
      { true, BaseValue, MaxValue },
  ...
  public static TheoryData GetLessThanData => new TheoryData<bool, ushort, ushort>
    {
  ...
  public static TheoryData GetLessThanOrEqualData => new TheoryData<bool, ushort, ushort>
    {
      { true, BaseValue, MinValue },
      { false, BaseValue, BaseValue },
      { false, BaseValue, MaxValue }
  ...
  public static TheoryData GetNotPow2Data => new TheoryData<bool, ushort>
    {
      { true, 63 },
      { false, 64 }
    };
