...
public sealed class RequiresInt64Tests
{
  ...
  public static TheoryData GetInBetweenData => new TheoryData<bool, long, long, long>
    {
  ...
  public static TheoryData GetNotBetweenData => new TheoryData<bool, long, long, long>
    {
  ...
  public static TheoryData GetGreaterThanData => new TheoryData<bool, long, long>
    {
  ...
  public static TheoryData GetGreaterThanOrEqualData => new TheoryData<bool, long, long>
    {
      { true, BaseValue, MaxValue },
  ...
  public static TheoryData GetLessThanData => new TheoryData<bool, long, long>
    {
  ...
  public static TheoryData GetLessThanOrEqualData => new TheoryData<bool, long, long>
    {
      { true, BaseValue, MinValue },
      { false, BaseValue, BaseValue },
      { false, BaseValue, MaxValue }
  ...
  public static TheoryData GetNotPow2Data => new TheoryData<bool, long>
    {
      { true, 63 },
      { false, 64 }
    };
